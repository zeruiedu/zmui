...
public class ZMUIRecimgView extends ImageView {
    ...
    public ZMUIRecimgView(Context context) {
        this(context, null);
    }

    public ZMUIRecimgView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }
    ZMUIRecimgView(Context context, AttributeSet attrs, int defStyleAttr) {
