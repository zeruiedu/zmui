...
public class ZMUIRelativeLayout extends RelativeLayout {
    ...
    public ZMUIRelativeLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ZMUIRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
